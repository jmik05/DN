	...
	\begin{columns}
		...
		\begin{column}{0.45\textwidth}
			\begin{tikzpicture}
				...
				\draw (B) circle (1.5pt);
				\pause
				\coordinate [label=below left:{\scriptsize $A$}] (T') at (-\td,\tt);
				\draw[gray, thin] (T') arc[start angle=60, end angle=-60, radius=2] node[right] {\scriptsize $l$};
				\pause
				\coordinate [label=below left:{\scriptsize $A$}] (T'') at (\td,\tt);
				\draw[gray, thin] (T'') arc[start angle=120, end angle=240, radius=2] node[right] {\scriptsize $m$};
				\pause
