...
tip (npr.\begin{verbatim}
   \,bool
\end{verbatim} v C++), kjer bi vrednost true predstavljala
...
kršitev omejitve $n$, z $u_{n}$ pa njeno utež. Z naslednjo formulo izračunamo
kakovost urnika:
...
\section{Avtomatizirana izdelava}
